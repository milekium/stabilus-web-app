...
import { floor } from 'src/modules/utils/big-math';
import { NoMicro, Token, u } from 'src/modules/utils/types';
import big, { BigSource } from 'big.js';
import { demicrofy, MICRO } from './currency';
import { formatDemimal, formatInteger } from './unit_formatter';
...
export function formatNumeric(n: u<Token<BigSource>>, decimals = 6): string {
